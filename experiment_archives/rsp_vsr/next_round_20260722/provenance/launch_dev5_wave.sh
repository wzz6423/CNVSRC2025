...
code_dir="/hy-tmp/rsp-vsr-dev5-1e61295/VSR"
output_root="/hy-tmp/experiments/rsp_vsr/chinese_lips_trainpool_dev5_feature_film_1e61295"
...
case "${wave}" in
  ...
  2)
    ...
    ;;
  *)
    echo "WAVE_NUMBER must be 1 or 2" >&2
    exit 2
    ;;
esac
