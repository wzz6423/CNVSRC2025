...
\begin{enumerate}
  ...
  \item We show that a residual adapter updated from one correction every ten utterances yields a stable 2.42-point absolute CER gain over the static model on Chinese-LiPS, with low three-seed variance.
