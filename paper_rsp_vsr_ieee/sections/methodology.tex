...
\subsection{Dynamic-Expert Hypothesis}
...
This expert bank is not assumed to be superior. We test two necessary conditions: (i) expert routing must avoid collapse and reuse the first speaker's expert on return; and (ii) its overall CER or static-corrected revisit forgetting must materially improve over one adapter. Failure of either condition is a no-go result for the structural hypothesis.
